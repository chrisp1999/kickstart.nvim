...
vim.keymap.set('n', '<leader>ch', '<cmd>split<CR><cmd>term<CR> i', { desc = 'Open [C]onsole [H]orizontally' })
vim.keymap.set('n', '<leader>cv', '<cmd>vs<CR><cmd>term<CR> i', { desc = 'Open [C]onsole [V]ertically' })
